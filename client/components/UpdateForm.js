...
const UpdateForm = ({ props }) => {
    ...
    return (
        <div className="card relative overflow-hidden flex flex-col justify-between lg:w-full h-[255px] my-4 lg:mx-2 ">
            <div className="form-control my-1">
                <label className="text-xl text text-gray-700 font-semibold">Description :</label>
                <textarea
                    placeholder="Type here"
                    className="h-full form-control-input border-neutral-400 focus:ring-neutral-200"
                    value={description}
